...
public class FrmCliente extends javax.swing.JFrame {
    ...
    public void selecionar (){
        ...
        lblCod.setText(tblCli.getValueAt(tblCli.getSelectedRow(), 1).toString());
        lblCod.setText(tblCli.getValueAt(tblCli.getSelectedRow(), 2).toString());
        lblCod.setText(tblCli.getValueAt(tblCli.getSelectedRow(), 3).toString());
        lblCod.setText(tblCli.getValueAt(tblCli.getSelectedRow(), 4).toString());
    }//fim selecionar
